...
export function AnimatedTestimonials({
  ...
  return (
    <section
      ref={sectionRef}
      id="testimonials"
      className={`py-16 max-w-7xl mx-auto overflow-hidden bg-muted/30 ${className ?? ""}`}
    >
        ...
        >
          ...
          >
            {testimonials.map((testimonial, index) => (
              ...
              >
                <div className="bg-card border shadow-lg rounded-xl p-8 flex flex-col">
                  <div className="mb-6 flex gap-2">
                    {Array(testimonial.rating)
                      ...
                      .map((_, i) => (
                        <Star
                          key={i}
                          className="h-5 w-5 fill-[#e09a34] text-[#e09a34]"
                        />
                      ))}
                  </div>
